...
ホーム画面名は「近況」。公開投稿、コメント、初回の「みたよ」を新しい順に表示する。誰が、どの投稿に、いつ操作したかを表示し、タップするとPost Detailを開く。右上の「投稿一覧」から従来のTimelineを開ける。
...
公開済みの写真・動画を撮影日時の新しい順に並べ、年・月ごとにまとめて3列gridで表示する。Mediaを押すとMedia Viewerを開き、閉じるとアルバムへ戻る。
